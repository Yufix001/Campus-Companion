    ...
    <div className="font-sans text-slate-900 antialiased h-screen flex flex-col overflow-hidden bg-slate-50/50">
      <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200 shrink-0 z-20 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-serif font-bold text-[#07305B] tracking-tight leading-none">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <nav className="hidden md:flex w-20 flex-col bg-white border-r border-slate-200 items-center py-6 gap-8 z-10">
          ...
          <div className="flex flex-col items-center gap-1 opacity-60 mt-auto pb-4">
            ...
            <span className="text-[8px] font-bold text-slate-400 text-center uppercase">
              Intranet Agent
            </span>
          </div>
        </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-full">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="text-[10px] text-slate-400 font-medium tracking-tight bg-white border border-slate-200 px-2 py-1 rounded-sm">
                  ID: #HEC-8829
                </span>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-[4px] shadow-[0_1px_3px_rgba(0,0,0,0.05)] flex flex-col h-fit">
                <div className="p-5 border-b border-slate-100">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-[#07305B] uppercase tracking-wide">
                      Student Query
                    </span>
                  </div>
                  <h3 className="text-lg font-serif font-bold mb-2 text-slate-900">
                    Registrar Access Error
                  </h3>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    "I cannot access my course registration page. The screen
                    just shows an error message saying unauthorized after the
                    latest system update. I need to register for the Strategy
                    elective before 5 PM."
                  </p>
                </div>
                <div className="bg-slate-50 p-4 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-[#07305B] text-white flex items-center justify-center text-[10px] font-bold">
                      JD
                    </div>
                    <div>
              ...
              <div className="bg-white border border-slate-200 rounded-[4px] shadow-sm p-4 opacity-80">
                ...
                <p className="text-xs text-slate-500 italic">
                  "Portal latency reported by 3 other students in the last
                  hour."
                </p>
              </div>
            </div>
                ...
                <div className="bg-white border border-[#07305B]/20 rounded-[4px] shadow-[0_1px_3px_rgba(0,0,0,0.05)] overflow-hidden flex-shrink-0">
                  <div className="bg-[#07305B]/5 px-4 py-3 border-b border-[#07305B]/10 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-[#07305B] uppercase tracking-wider">
                  ...
                  <div className="p-5">
                    <div className="font-serif text-slate-800 text-sm leading-relaxed space-y-4">
                      <p className="font-bold text-[#07305B]">
                        Subject: Portal Access Resolution
                      </p>
                      <p>Dear Jean,</p>
                      <p>
                        We have processed your request regarding the access
                        issues. Our support team has refreshed the permissions
                        on your account following the recent maintenance cycle.
                      </p>
                      <p>
