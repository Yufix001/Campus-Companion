        ...
        <div className="min-h-screen flex items-center justify-center bg-[#07305B] font-display">
            <div className="w-full max-w-md p-8 glass-panel sharp-corners bg-white shadow-xl relative overflow-hidden">
                ...
                <div className="flex flex-col items-center mb-8">
                    <ShieldCheck className="w-12 h-12 text-[#07305B] mb-4 opacity-80" strokeWidth={1.5} />
                    <h1 className="font-serif text-2xl text-[#07305B] font-bold">Admin Dashboard</h1>
                    <p className="text-xs text-[#07305B]/60 uppercase tracking-widest mt-2">Restricted Access</p>
                </div>
