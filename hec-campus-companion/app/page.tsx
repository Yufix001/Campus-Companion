      ...
      <nav className="sticky top-0 z-50 px-4 pt-4 pb-2 w-full max-w-md mx-auto">
        <div className="glass-panel sharp-corners px-5 py-3 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="font-serif font-bold text-lg tracking-tighter uppercase text-[#07305B]">
              Campus Companion
            </div>
          </div>
      ...
      <main className="relative z-10 w-full max-w-md mx-auto px-4 flex flex-col gap-6">
        <header className="mt-8 flex flex-col items-start gap-4">
          <div className="flex flex-col">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#07305B]/60 mb-1">
              VIRTUAL ASSISTANT
            </span>
            <h2 className="font-serif text-xl italic text-[#07305B]/80">
        ...
        <div
          className="w-full h-48 bg-cover bg-center sharp-corners"
          style={{
            backgroundImage:
        ...
        <section className="flex flex-col gap-8 mt-2">
          ...
          <div className="bg-white sharp-corners p-8 shadow-sm relative overflow-hidden border border-slate-100">
            ...
            <span className="text-[10px] font-bold text-[#0048E5] uppercase tracking-[0.2em] block mb-3">
              Our Story
            </span>
            <h3 className="font-serif text-[28px] font-medium leading-tight mb-5 text-[#07305B]">
              Why we built this
            </h3>
            <p className="text-slate-600 text-sm leading-[1.6] mb-8 font-light">
              Let&apos;s be honest: navigating life on the Jouy-en-Josas campus
              shouldn&apos;t be a puzzle. Between missing the last shuttle to
              Versailles and digging through endless PDFs to find basic campus
              info, we&apos;ve all been there. Campus Companion was born from
              this exact frustration. It&apos;s built by students, for
              students—one single hub to eliminate the friction and get you the
              answers you need, instantly.
            </p>
            <div className="flex flex-col gap-3 pt-6 border-t border-slate-100">
              <span className="text-[9px] uppercase font-bold text-slate-400 tracking-[0.15em]">
                Backed by the ecosystem of:
              </span>
          ...
          <div className="flex flex-col gap-4 mt-6">
            <div className="flex items-center gap-4 mb-2">
              <h3 className="font-serif text-[28px] font-medium text-[#07305B]">
                The Team
              </h3>
            ...
            <div className="bg-white sharp-corners p-6 border border-slate-100 shadow-sm flex gap-5 items-start">
              ...
              <div className="flex flex-col pt-1">
                <h4 className="font-serif font-bold text-[#07305B] text-xl leading-none mb-1">
                  Yusu Chen
                </h4>
                <span className="text-[10px] font-bold text-[#0048E5] uppercase tracking-[0.15em] mb-3 block">
                  Founder & Product
                </span>
                <p className="text-slate-600 text-sm font-light leading-[1.6]">
                  HEC MBA Student S24. Passionate about AI and tech. Building
                  the tool we always needed on campus.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white sharp-corners p-6 border border-slate-100 shadow-sm flex flex-col items-start">
              <div className="flex gap-5 items-start w-full">
                ...
                <div className="flex flex-col pt-0 flex-1">
                  ...
                  <p className="text-slate-600 text-sm font-light leading-[1.6]">
                    Are you from IP Paris or HEC and dream in code? Join us to
                    scale the AI, connect the APIs, and build the ultimate
                    campus app.
                  </p>
                  <a
                    href="https://tally.so/r/687pyO"
                    target="_blank"
            ...
            <div className="bg-white sharp-corners p-6 border border-slate-100 shadow-sm flex flex-col items-start">
              <div className="flex gap-5 items-start w-full">
                ...
                <div className="flex flex-col pt-0 flex-1">
                  ...
                  <p className="text-slate-600 text-sm font-light leading-[1.6]">
                    Know the campus inside out? Help us deploy the app, grow our
                    user base, and connect the dots across the Jouy ecosystem.
                  </p>
                  <a
                    href="https://tally.so/r/687pyO"
                    target="_blank"
        ...
        <footer className="mt-8 flex flex-col items-center gap-6 text-center border-t border-[#07305B]/10 pt-10 pb-10">
          <div className="flex items-center gap-2">
            <div className="font-serif font-bold text-lg tracking-tight text-[#07305B]">
              HEC PARIS
            </div>
          </div>
          <div className="flex gap-6">
            <a
              className="text-[10px] font-bold uppercase tracking-widest text-[#07305B]/60 hover:text-accent"
              href="#"
            >
              Contact
            </a>
          ...
          <p className="text-[9px] text-[#07305B]/40 uppercase tracking-[0.3em]">
            © 2024 HEC PARIS. EXCELLENCE IN MOTION.
          </p>
        </footer>
      </main>
    </div>
