    ...
    return (
        <div className="font-sans antialiased min-h-screen bg-[#F9F9F7] dark:bg-[#0F172A] text-slate-900 pb-32">
            <header className="px-6 pt-8 pb-4">
                <h1 className="font-serif text-3xl mb-1 text-[#07305B] dark:text-white tracking-tight">Schedule</h1>
            </header>
            <main className="px-6 flex flex-col items-center justify-center h-[50vh] text-center">
                ...
                <p className="text-sm text-slate-500 max-w-xs">Your academic schedule integration is currently under development.</p>
            </main>
            <BottomNav />
        </div>
    )
