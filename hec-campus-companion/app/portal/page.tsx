    ...
    <div className="font-sans antialiased min-h-screen bg-[#F9F9F7] dark:bg-[#0F172A] text-slate-900 pb-32">
      ...
      <main className="px-6 space-y-6">
        ...
        <div className="py-6 flex flex-col items-center justify-center">
          <Link
            href="/chat"
            className="glass-btn group relative flex items-center justify-center w-full max-w-sm h-20 rounded-xl border border-[#07305B] transition-all duration-300 active:scale-[0.98] bg-white/25 backdrop-blur-md shadow-[0_4px_20px_rgba(7,48,91,0.1)] appearance-none"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <span className="block text-[#07305B] font-serif font-bold text-lg leading-tight">
                  Ask HEC Assistant
                </span>
          ...
          <p className="mt-4 text-slate-400 dark:text-slate-500 text-xs italic font-light tracking-wide text-center max-w-xs mx-auto">
            "What is the schedule for Strategic Marketing?"
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-0 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <Link
            href="/portal/campus"
            className="p-5 flex items-center justify-between group cursor-pointer hover:bg-slate-50 transition-colors"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-sm">
                  SAVAC Shuttle Schedule
                </h3>
                <p className="text-xs text-[#0048E5] font-medium">
                  Next departure in 12 mins
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <a
            href="https://booking.hec.fr/myadebooking/#HomePage"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col justify-between h-32 relative overflow-hidden group shadow-sm hover:border-[#07305B]/30 transition-colors"
          >
