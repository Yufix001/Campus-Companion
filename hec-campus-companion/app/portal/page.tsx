        ...
        <div className="font-sans antialiased min-h-screen bg-[#F9F9F7] dark:bg-[#0F172A] text-slate-900 pb-32">
            ...
            <main className="px-6 space-y-6">
                ...
                <div className="bg-white dark:bg-slate-800 p-0 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                    <a href="https://www.transilien.com/fr/gare/jouy-en-josas-8739363" target="_blank" rel="noopener noreferrer" className="p-5 flex items-center justify-between group cursor-pointer hover:bg-slate-50 transition-colors no-underline">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">View Live Schedule</p>
                            </div>
                        </div>
