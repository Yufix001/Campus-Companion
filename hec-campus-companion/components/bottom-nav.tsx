...
import { Home, Info, Newspaper, LogIn, Search, MessageSquare, Calendar, Map, User } from "lucide-react"
...
export function BottomNav() {
    ...
    const isPortal = pathname.startsWith("/portal") || pathname.startsWith("/chat")
            ...
            <div className="fixed bottom-6 left-6 right-6 z-50">
                <nav className="glass-nav rounded-2xl p-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex items-center justify-between relative">
                    ...
                    >
                        ...
                        <span className="text-[9px] mt-1 uppercase tracking-wider font-semibold">Chat</span>
                    </Link>
                    ...
                    >
                        <Calendar size={24} />
                        <span className="text-[9px] mt-1 uppercase tracking-wider font-semibold">Schedule</span>
                    </Link>
                  ...
                  */}
                    ...
                    >
                        <Map size={24} />
                        <span className="text-[9px] mt-1 uppercase tracking-wider font-semibold">Campus</span>
                    </Link>
                    ...
                    >
                        <User size={24} />
                        <span className="text-[9px] mt-1 uppercase tracking-wider font-semibold">Profile</span>
                    </Link>
                </nav>
            </div>
        )
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full glass-panel border-t border-[#07305B]/5 py-3 px-6 z-[60]">
            <div className="max-w-md mx-auto flex justify-between items-center">
                ...
                <button className="flex flex-col items-center gap-1 text-[#07305B]/40 hover:text-[#07305B]">
                    <Newspaper size={24} />
                    <span className="text-[9px] font-bold uppercase tracking-tighter">News</span>
                </button>

                <Link href="/portal" className="flex flex-col items-center gap-1 text-[#07305B]/40 hover:text-[#07305B]">
                    <LogIn size={24} />
