...
export function TransportWidget({ variant = "sidebar" }: TransportWidgetProps) {
  ...
  if (variant === "full") {
    return (
      <a
        href="https://www.bonjour-ratp.fr/horaires-transilien/ligne-v/jouy-en-josas/"
        target="_blank"
        rel="noopener noreferrer"
        className="p-5 block group cursor-pointer hover:bg-slate-50 transition-colors no-underline"
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-50 rounded-lg p-3 border border-slate-100">
            ...
            <div className="flex items-end gap-2">
              <span className="text-lg font-bold text-[#07305B]">
                {schedule.versailles.wait} min
              </span>
              <span className="text-xs text-slate-400 mb-1">
                {schedule.versailles.time}
              </span>
            </div>
          </div>
          <div className="bg-slate-50 rounded-lg p-3 border border-slate-100">
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="editorial-border bg-white p-4 flex flex-col justify-between h-full sharp-corners no-underline hover:bg-slate-50 transition-colors"
    >
      <div className="flex justify-between items-start mb-2">
        <VLogo />
        <span className="text-[10px] font-bold uppercase tracking-widest text-[#07305B]/50">
          Transport
        </span>
      </div>
      <div className="flex flex-col gap-2">
        <div className="flex flex-col">
          <span className="text-[9px] text-[#07305B]/60 uppercase tracking-wider mb-0.5">
            To Versailles
          </span>
          <div className="flex items-baseline justify-between">
            <span className="text-sm font-serif font-medium text-[#07305B]">
              {schedule.versailles.time}
            </span>
