...
export function FutureExpansion() {
    return (
        <section className="bg-[#0A0A0A] border-y border-[#0A0A0A] py-12 overflow-hidden">
            {/* Text Marquee */}
            <div className="relative w-full overflow-hidden mb-12 opacity-80">
                <div className="w-[200%] flex animate-marquee">
                    <div className="flex w-1/2 items-center justify-around whitespace-nowrap px-4">
                        <span className="text-4xl font-serif italic text-white/80">Coming soon to IP Paris Universities & more...</span>
                        <span className="text-4xl font-serif italic text-white/80">Coming soon to IP Paris Universities & more...</span>
                        <span className="text-4xl font-serif italic text-white/80">Coming soon to IP Paris Universities & more...</span>
                    </div>
                    <div className="flex w-1/2 items-center justify-around whitespace-nowrap px-4">
            ...
            <div className="max-w-md mx-auto px-4 flex flex-col items-center text-center">
                <span className="text-[10px] font-bold uppercase tracking-widest text-white/80 mb-8">Future Expansions</span>
                ...
                <div className="relative w-full overflow-hidden mb-10 group" style={{ maskImage: "linear-gradient(to right, transparent, black 15%, black 85%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 15%, black 85%, transparent)" }}>
                    <div className="flex w-[200%] animate-marquee group-hover:[animation-play-state:paused] items-center">
                        ...
                        <div className="flex w-1/2 justify-around items-center px-4 gap-8">
                            <div className="w-12 h-12 relative flex-shrink-0 transition-all duration-300 filter brightness-0 invert opacity-70 group-hover:filter-none group-hover:opacity-100">
                                <Image src="/assets/polytechnique.png" alt="Polytechnique" fill className="object-contain" />
                            </div>
                            <div className="w-16 h-8 relative flex-shrink-0 transition-all duration-300 filter brightness-0 invert opacity-70 group-hover:filter-none group-hover:opacity-100">
                            ...
                            <div className="w-16 h-10 relative flex-shrink-0 transition-all duration-300 filter brightness-0 invert opacity-70 group-hover:filter-none group-hover:opacity-100">
                ...
                <Link href="/waitlist">
                    <Button variant="outline" className="border-white/20 text-white hover:bg-white hover:text-[#0A0A0A] text-[10px] font-bold uppercase tracking-widest px-8 sharp-corners h-9 transition-colors">
