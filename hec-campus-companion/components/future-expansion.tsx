  ...
  return (
    <section className="py-12 overflow-hidden">
      <div className="max-w-md mx-auto px-4 flex flex-col items-center text-center">
        <span className="text-[10px] font-bold uppercase tracking-widest text-[#07305B]/40 mb-8">
          Joining the Ecosystem soon
        </span>
          ...
          >
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex items-center gap-8 mx-4">
                ...
                <div className="w-[160px] h-[80px] relative flex-shrink-0 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_25px_rgba(59,130,246,0.8)] flex items-center justify-center">
                  <Image
                    src="/assets/polytechnique-signature.svg"
                ...
                <div className="w-[160px] h-[80px] relative flex-shrink-0 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_25px_rgba(59,130,246,0.8)] flex items-center justify-center">
                  <Image
                    src="/assets/ponts-paristech.svg"
                ...
                <div className="w-[160px] h-[80px] relative flex-shrink-0 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_25px_rgba(59,130,246,0.8)] flex items-center justify-center">
                  <Image
                    src="/assets/imt-icon.png"
                    alt="Institut Mines-Télécom"
                    width={80}
                    height={80}
                    className="object-contain max-h-[70px] w-auto"
                  />
